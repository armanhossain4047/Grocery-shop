 ...
 * @author user
 */
public class SalesReportByCustomer extends javax.swing.JFrame {

    /**
     * Creates new form SalesReportByCustomer
     */
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Sales Report By Customer"));
        ...
        setSize(new java.awt.Dimension(365, 242));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SalesReportByCustomer.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SalesReportByCustomer().setVisible(true);
            }
        });
    }
