...
public class Receipt extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        DecscriptionTbl.setFont(new java.awt.Font("Arial", 1, 12)); // NOI18N
    ...
    private void ReosoneCmbActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ReosoneCmbActionPerformed
        ...
        String query = "SELECT * FROM `ladger` WHERE AccountType= '" + ReosoneCmb.getSelectedItem().toString() + "'";
