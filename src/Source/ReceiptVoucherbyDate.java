 ...
 * @author user
 */
public class ReceiptVoucherbyDate extends javax.swing.JFrame {

    /**
     * Creates new form ReceiptVoucherbyDate
     */
    public ReceiptVoucherbyDate() {
        initComponents();
        intilize();
    }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Date", "Voucher Type", "Voucher No", "Debit From", "Description", "Amount", "Deo"
            }
        ));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ReceiptVoucherbyDate.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ReceiptVoucherbyDate().setVisible(true);
            }
        });
    }
